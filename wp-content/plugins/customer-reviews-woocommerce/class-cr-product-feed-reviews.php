    ...
    protected function init_settings() {
      ...
      $this->settings = array(
        ...
        array(
  				...
  				'title'    => __( 'Minimum Length of Reviews', IVOLE_TEXT_DOMAIN ),
  				'desc'     => __( 'Google might reject XML feeds with very short reviews. Use this setting to specify a minimum number of characters that a review should have to be included in the XML feed.', IVOLE_TEXT_DOMAIN ),
  				'default'  => 0,
  				'type'     => 'number',
          'desc_tip' => true
  			),
