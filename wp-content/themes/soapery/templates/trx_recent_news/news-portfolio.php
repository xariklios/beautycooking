...
if ( !function_exists( 'soapery_template_news_portfolio_theme_setup' ) ) {
	add_action( 'soapery_action_before_init_theme', 'soapery_template_news_portfolio_theme_setup', 1 );
	function soapery_template_news_portfolio_theme_setup() {
		soapery_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'soapery'),
...
// Template output
if ( !function_exists( 'soapery_template_news_portfolio_output' ) ) {
	function soapery_template_news_portfolio_output($post_options, $post_data) {
