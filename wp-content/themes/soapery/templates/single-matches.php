...
if ( !function_exists( 'soapery_template_single_matches_theme_setup' ) ) {
	add_action( 'soapery_action_before_init_theme', 'soapery_template_single_matches_theme_setup', 1 );
	function soapery_template_single_matches_theme_setup() {
		soapery_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'soapery'),
...
// Template output
if ( !function_exists( 'soapery_template_single_matches_output' ) ) {
	function soapery_template_single_matches_output($post_options, $post_data) {
