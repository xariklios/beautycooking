...
if ( !function_exists( 'soapery_template_services_3_theme_setup' ) ) {
	add_action( 'soapery_action_before_init_theme', 'soapery_template_services_3_theme_setup', 1 );
	function soapery_template_services_3_theme_setup() {
		soapery_add_template(array(
			'layout' => 'services-3',
			'template' => 'services-3',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 3/', 'soapery'),
...
// Template output
if ( !function_exists( 'soapery_template_services_3_output' ) ) {
	function soapery_template_services_3_output($post_options, $post_data) {
