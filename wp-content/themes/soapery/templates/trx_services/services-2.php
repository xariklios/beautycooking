...
if ( !function_exists( 'soapery_template_services_2_theme_setup' ) ) {
	add_action( 'soapery_action_before_init_theme', 'soapery_template_services_2_theme_setup', 1 );
	function soapery_template_services_2_theme_setup() {
		soapery_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'soapery'),
...
// Template output
if ( !function_exists( 'soapery_template_services_2_output' ) ) {
	function soapery_template_services_2_output($post_options, $post_data) {
