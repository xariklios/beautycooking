...
if ( !function_exists( 'soapery_template_testimonials_4_theme_setup' ) ) {
	add_action( 'soapery_action_before_init_theme', 'soapery_template_testimonials_4_theme_setup', 1 );
	function soapery_template_testimonials_4_theme_setup() {
		soapery_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 4/', 'soapery'),
...
// Template output
if ( !function_exists( 'soapery_template_testimonials_4_output' ) ) {
	function soapery_template_testimonials_4_output($post_options, $post_data) {
		$show_title = true;
