<div class="to_demo_wrap">
	<a href="" class="to_demo_pin iconadmin-pin" title="<?php esc_attr_e('Pin/Unpin demo-block by the right side of the window', 'soapery'); ?>"></a>
			...
			if (is_array($colors) && count($colors) > 0) {
				foreach ($colors as $slug=>$scheme) { 
					...
					<?php if (isset($scheme['accent4'])) { ?>
						<div class="to_demo_columns3"><p class="to_demo_text"><span class="to_demo_accent4">accent4 example</span> and <span class="to_demo_accent4_hover">hovered accent4</span></p></div>
					<?php } ?>
					...
					<?php if (isset($scheme['accent4'])) { ?>
						<div class="to_demo_columns3 to_demo_accent4_bg to_demo_inverse_block">
							<h4 class="to_demo_accent4_hover_bg to_demo_inverse_dark">Accented block header</h4>
							<div>
								<p class="to_demo_inverse_light">Posted <span class="to_demo_inverse_link">12 May, 2015</span> by <span class="to_demo_inverse_hover">Author name hovered</span>.</p>
								<p class="to_demo_inverse_text">This is a inversed colors example for the normal text</p>
								<p class="to_demo_inverse_text"><span class="to_demo_inverse_link">link example</span> and <span class="to_demo_inverse_hover">hovered link</span></p>
